...
func (t *Transaction) AddBuyOrderPendingShares(share int) {
	t.BuyingOrder.PendingShares += share
}

func (t *Transaction) AddSellOrderPendingShares(share int) {
	t.SellingOrder.PendingShares += share
}
